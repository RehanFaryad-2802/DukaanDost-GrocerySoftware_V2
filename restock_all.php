...
// Only admin and manager can restock
...
if (isset($_POST['confirm_restock'])) {
    try {
        ...
        // Update ALL active products to 999999
        $stmt = $pdo->prepare("
            UPDATE products 
            SET current_stock = ? 
            WHERE status = 'active'
            ...
            <div class="card-body">
                <div class="row text-center">
                    <div class="col-md-4">
                        ...
                        <div class="big-number text-primary"><?php echo number_format($stats['total_products']); ?></div>
                    </div>
                    <div class="col-md-4">
        ...
        <div class="card danger-zone">
            ...
            <div class="card-body">
                <div class="alert alert-warning">
                    ...
                    <strong>Warning:</strong> This will set <strong>ALL <?php echo number_format($stats['total_products']); ?> products</strong> 
                    to exactly <strong><?php echo number_format($restock_value); ?></strong> units, regardless of their current stock!
                </div>
                ...
                <form method="POST" onsubmit="return confirm('ARE YOU ABSOLUTELY SURE?\n\nThis will set ALL <?php echo $stats['total_products']; ?> products to 999,999 units!\n\nType YES to confirm.');">
                    <div class="mb-3">
                        ...
                        <input type="text" name="confirm_text" id="confirm_text" class="form-control" 
                               ...
                               oninput="document.getElementById('restock_btn').disabled = this.value !== 'YES'">
                    </div>
                    
                    <div class="d-grid">
                        <button type="submit" name="confirm_restock" id="restock_btn" 
