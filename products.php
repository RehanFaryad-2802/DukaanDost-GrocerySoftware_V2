                ...
                <tbody>
                    <?php foreach ($products as $product):
                        ...
                        <tr>
                            ...
                            <td>Rs. <?php echo number_format($product['purchase_price'] ?? 0, 2); ?></td>
                            <td>Rs. <?php echo number_format($retail, 2); ?></td>
                            <td>Rs. <?php echo number_format($wholesale, 2); ?></td>
                            <td>
