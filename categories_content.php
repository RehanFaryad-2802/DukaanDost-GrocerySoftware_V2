                                ...
                                <tr>
                                    ...
                                    <td>
                                        <button class="btn btn-sm btn-outline-primary"
                                            onclick="assignCategory(<?php echo $p['id']; ?>)">
                                            Assign Category
                                        </button>
                                    </td>
                                </tr>
                    ...
                    <div class="modal-body">
                        <div class="row">
                            ...
                            <div class="col-md-4 mb-3">
                                ...
                                <input type="number" name="min_stock_alert" class="form-control" step="0.001"
                                    value="10">
                            </div>
                            <div class="col-md-4 mb-3">
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="number" name="wholesale_min_qty" class="form-control" step="0.001"
                                    value="5">
                            </div>
                        </div>
                    </div>
