...
CREATE TABLE products (
    ...
    category VARCHAR(50),
    current_stock DECIMAL(10,0) DEFAULT 0,
    min_stock_alert DECIMAL(10,0) DEFAULT 10,
...
CREATE TABLE pricing_tiers (
    ...
    min_quantity DECIMAL(10,0) NOT NULL,
    max_quantity DECIMAL(10,0) NULL,
    price_per_unit DECIMAL(10,0) NOT NULL,
    package_price DECIMAL(10,0) NULL COMMENT 'Fixed price for exact quantity',
...
CREATE TABLE invoices (
    ...
    discount_percent DECIMAL(5,0) DEFAULT 0,
