                ...
                <form onsubmit="updateProduct(event, ${id})">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="mb-3">
                            <label>Product Code *</label>
                            <div class="input-group">
                                <input readonly type="text" name="code" class="form-control" value="${product.code}" required>
                                <button disabled type="button" class="btn btn-outline-secondary" onclick="generateCodeForEdit()">
                                    <i class="bi bi-arrow-repeat"></i> Generate
                                </button>
                            </div>
                        </div>
